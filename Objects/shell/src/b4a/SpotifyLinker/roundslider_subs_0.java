...
__ref.runClassMethod (b4a.SpotifyLinker.roundslider.class, "_createthumb" /*RemoteObject*/ );};
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.SpotifyLinker.roundslider.class, "_draw" /*RemoteObject*/ );
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.SpotifyLinker.roundslider.class, "_base_resize" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth"))),(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight"))));
...
try {
		Debug.PushSubsStack("getValue (roundslider) ","roundslider",29,__ref.getField(false, "ba"),__ref,154);
...
try {
		Debug.PushSubsStack("setValue (roundslider) ","roundslider",29,__ref.getField(false, "ba"),__ref,149);
