...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.SpotifyLinker.b4xseekbar.class, "_update" /*RemoteObject*/ );
...
__ref.runClassMethod (b4a.SpotifyLinker.b4xseekbar.class, "_base_resize" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth"))),(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight"))));};
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.SpotifyLinker.b4xseekbar.class, "_raisetouchstateevent" /*RemoteObject*/ );
 BA.debugLineNum = 92;BA.debugLine="SetValueBasedOnTouch(X, Y)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (b4a.SpotifyLinker.b4xseekbar.class, "_setvaluebasedontouch" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, _x)),(Object)(BA.numberCast(int.class, _y)));
 }else 
