...
public boolean isSingleton() {
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("httputils2service"), "b4a.SpotifyLinker.httputils2service");
	}
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
        ...
        remoteMe = RemoteObject.declareNull("b4a.SpotifyLinker.httputils2service");
...
public static b4a.SpotifyLinker.b4xcollections _b4xcollections = null;
  public Object[] GetGlobals() {
		return new Object[] {"B4XCollections",Debug.moduleToString(b4a.SpotifyLinker.b4xcollections.class),"Common",Debug.moduleToString(b4a.SpotifyLinker.common.class),"Config",Debug.moduleToString(b4a.SpotifyLinker.config.class),"DateUtils",httputils2service.mostCurrent._dateutils,"hc",httputils2service._hc,"Main",Debug.moduleToString(b4a.SpotifyLinker.main.class),"Service",httputils2service.mostCurrent._service,"Starter",Debug.moduleToString(b4a.SpotifyLinker.starter.class),"taskCounter",httputils2service._taskcounter,"TaskIdToJob",httputils2service._taskidtojob,"TempFolder",httputils2service._tempfolder,"XUIViewsUtils",Debug.moduleToString(b4a.SpotifyLinker.xuiviewsutils.class)};
}
}