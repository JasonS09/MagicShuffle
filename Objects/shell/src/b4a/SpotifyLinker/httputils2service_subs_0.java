...
if (RapidSub.canDelegate("completejob")) { return b4a.SpotifyLinker.httputils2service.remoteMe.runUserSub(false, "httputils2service","completejob", _taskid, _success, _errormessage);}
RemoteObject _job = RemoteObject.declareNull("b4a.SpotifyLinker.httpjob");
...
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","45373958",RemoteObject.concat(RemoteObject.createImmutable("HttpUtils2Service: job completed multiple times - "),_taskid),0);
...
_job.runClassMethod (b4a.SpotifyLinker.httpjob.class, "_complete" /*RemoteObject*/ ,(Object)(_taskid));
...
if (RapidSub.canDelegate("hc_responseerror")) { return b4a.SpotifyLinker.httputils2service.remoteMe.runUserSub(false, "httputils2service","hc_responseerror", _response, _reason, _statuscode, _taskid);}
RemoteObject _job = RemoteObject.declareNull("b4a.SpotifyLinker.httpjob");
...
Debug.ShouldStop(131072);
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","45308421",RemoteObject.concat(RemoteObject.createImmutable("HttpUtils2Service (hc_ResponseError): job completed multiple times - "),_taskid),0);
...
if (RapidSub.canDelegate("hc_responsesuccess")) { return b4a.SpotifyLinker.httputils2service.remoteMe.runUserSub(false, "httputils2service","hc_responsesuccess", _response, _taskid);}
RemoteObject _job = RemoteObject.declareNull("b4a.SpotifyLinker.httpjob");
...
Debug.ShouldStop(16777216);
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","45177347",RemoteObject.concat(RemoteObject.createImmutable("HttpUtils2Service (hc_ResponseSuccess): job completed multiple times - "),_taskid),0);
...
if (RapidSub.canDelegate("response_streamfinish")) { return b4a.SpotifyLinker.httputils2service.remoteMe.runUserSub(false, "httputils2service","response_streamfinish", _success, _taskid);}
Debug.locals.put("Success", _success);
Debug.locals.put("TaskId", _taskid);
...
if (RapidSub.canDelegate("service_create")) { return b4a.SpotifyLinker.httputils2service.remoteMe.runUserSub(false, "httputils2service","service_create");}
...
Debug.ShouldStop(2);
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","44915207",BA.ObjectToString(httputils2service.mostCurrent.__c.runMethod(false,"LastException",httputils2service.processBA)),0);
 BA.debugLineNum = 35;BA.debugLine="Log(\"Switching to File.DirInternal\")";
Debug.ShouldStop(4);
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","44915208",RemoteObject.createImmutable("Switching to File.DirInternal"),0);
...
if (RapidSub.canDelegate("service_destroy")) { return b4a.SpotifyLinker.httputils2service.remoteMe.runUserSub(false, "httputils2service","service_destroy");}
...
if (RapidSub.canDelegate("service_start")) { return b4a.SpotifyLinker.httputils2service.remoteMe.runUserSub(false, "httputils2service","service_start", _startingintent);}
...
if (RapidSub.canDelegate("submitjob")) { return b4a.SpotifyLinker.httputils2service.remoteMe.runUserSub(false, "httputils2service","submitjob", _job);}
...
Debug.ShouldStop(8192);
httputils2service._hc.runVoidMethod ("ExecuteCredentials",httputils2service.processBA,(Object)(_job.runClassMethod (b4a.SpotifyLinker.httpjob.class, "_getrequest" /*RemoteObject*/ )),(Object)(_taskid),(Object)(_job.getField(true,"_username" /*RemoteObject*/ )),(Object)(_job.getField(true,"_password" /*RemoteObject*/ )));
 }else {
 BA.debugLineNum = 80;BA.debugLine="hc.Execute(job.GetRequest, TaskId)";
Debug.ShouldStop(32768);
httputils2service._hc.runVoidMethod ("Execute",httputils2service.processBA,(Object)(_job.runClassMethod (b4a.SpotifyLinker.httpjob.class, "_getrequest" /*RemoteObject*/ )),(Object)(_taskid));
 };
