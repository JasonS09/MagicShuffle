...
public static RemoteObject _huebar = RemoteObject.declareNull("b4a.SpotifyLinker.b4xcolortemplate._colorpickerpart");
public static RemoteObject _colorpicker = RemoteObject.declareNull("b4a.SpotifyLinker.b4xcolortemplate._colorpickerpart");
public static RemoteObject _alphabar = RemoteObject.declareNull("b4a.SpotifyLinker.b4xcolortemplate._colorpickerpart");
public static RemoteObject _borderscolor = RemoteObject.createImmutable(0);
public static RemoteObject _xdialog = RemoteObject.declareNull("b4a.SpotifyLinker.b4xdialog");
