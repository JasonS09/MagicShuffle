...
public class madewithlove extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new anywheresoftware.b4a.ShellBA(_ba, this, htSubs, "b4a.SpotifyLinker.madewithlove");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.SpotifyLinker.madewithlove.class).invoke(this, new Object[] {null});
        else
...
public String  _base_resize(b4a.SpotifyLinker.madewithlove __ref,double _width,double _height) throws Exception{
__ref = this;
...
RDebugUtils.currentLine=24969217;
 //BA.debugLineNum = 24969217;BA.debugLine="mBase.GetView(0).SetLayoutAnimated(0, 0, 0, Wid";
__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .GetView((int) (0)).SetLayoutAnimated((int) (0),(int) (0),(int) (0),(int) (_width),(int) (_height));
RDebugUtils.currentLine=24969218;
 //BA.debugLineNum = 24969218;BA.debugLine="End Sub";
return "";
}
public String  _class_globals(b4a.SpotifyLinker.madewithlove __ref) throws Exception{
__ref = this;
RDebugUtils.currentModule="madewithlove";
...
RDebugUtils.currentLine=24772611;
 //BA.debugLineNum = 24772611;BA.debugLine="Public mBase As B4XView";
...
RDebugUtils.currentLine=24772613;
 //BA.debugLineNum = 24772613;BA.debugLine="Public Tag As Object";
_tag = new Object();
RDebugUtils.currentLine=24772614;
 //BA.debugLineNum = 24772614;BA.debugLine="End Sub";
return "";
}
public String  _designercreateview(b4a.SpotifyLinker.madewithlove __ref,Object _base,anywheresoftware.b4a.objects.LabelWrapper _lbl,anywheresoftware.b4a.objects.collections.Map _props) throws Exception{
__ref = this;
RDebugUtils.currentModule="madewithlove";
...
RDebugUtils.currentLine=24903683;
 //BA.debugLineNum = 24903683;BA.debugLine="Dim xlbl As B4XView = Lbl";
_xlbl = new anywheresoftware.b4a.objects.B4XViewWrapper();
_xlbl = (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_lbl.getObject()));
RDebugUtils.currentLine=24903698;
 //BA.debugLineNum = 24903698;BA.debugLine="Dim cs As CSBuilder";
_cs = new anywheresoftware.b4a.objects.CSBuilder();
RDebugUtils.currentLine=24903699;
 //BA.debugLineNum = 24903699;BA.debugLine="cs.Initialize.Append(\"Made with \").Typeface(Typef";
...
RDebugUtils.currentLine=24903700;
 //BA.debugLineNum = 24903700;BA.debugLine="xlbl.Text = cs";
_xlbl.setText(BA.ObjectToCharSequence(_cs.getObject()));
RDebugUtils.currentLine=24903701;
 //BA.debugLineNum = 24903701;BA.debugLine="xlbl.SetTextAlignment(\"CENTER\", \"CENTER\")";
_xlbl.SetTextAlignment("CENTER","CENTER");
RDebugUtils.currentLine=24903702;
 //BA.debugLineNum = 24903702;BA.debugLine="mBase.AddView(xlbl, 0, 0, mBase.Width, mBase.Heig";
...
RDebugUtils.currentLine=24903710;
 //BA.debugLineNum = 24903710;BA.debugLine="End Sub";
return "";
}
public String  _initialize(b4a.SpotifyLinker.madewithlove __ref,anywheresoftware.b4a.BA _ba,Object _callback,String _eventname) throws Exception{
__ref = this;
innerInitialize(_ba);
RDebugUtils.currentModule="madewithlove";
